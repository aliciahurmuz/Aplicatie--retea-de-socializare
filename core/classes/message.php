  ...
  class Message extends User{
    ...
    public function recentMessages($user_id){
     ...
     public function getMessages($messageFrom, $user_id){
      $stmt = $this->pdo->prepare("SELECT messages.*, users.profileImage FROM messages LEFT JOIN users ON messages.messageFrom = users.user_id WHERE (messages.messageFrom = :messageFrom AND messages.messageTo = :user_id) OR (messages.messageTo = :messageFrom AND messages.messageFrom = :user_id) ORDER BY messages.messageOn ASC");
