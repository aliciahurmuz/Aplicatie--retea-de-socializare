$(function(){
	$(document).on('click', '.t-show-popup', function(){
		...
		$.post('http://localhost/buzzly/core/ajax/popuptweets.php', {showpopup:tweet_id,user_id:user_id}, function(data){
	...
	$(document).on('click','.imagePopup', function(e){
		...
		$.post('http://localhost/buzzly/core/ajax/imagePopup.php', {showImage:tweet_id,user_id:user_id}, function(data){
			$('.popupTweet').html(data);
