$(function()
{
    $(document).on('click','.like-btn',function()
    {
        ...
        var button=$(this);
        $.post('http://localhost/buzzly/core/ajax/like.php',{like:tweet_id,user_id:user_id},function()
        {
            counter.show();
    ...
    $(document).on('click','.unlike-btn',function()
    {
        ...
        var count=counter.text();
        var button=$(this);
        $.post('http://localhost/buzzly/core/ajax/like.php',{unlike:tweet_id,user_id:user_id},function()
        {
            counter.show();
