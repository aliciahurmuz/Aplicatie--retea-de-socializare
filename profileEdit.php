		...
		if(!empty($_POST['screenName'])){
			...
			if(strlen($screenName) > 20){
				...
				$error = "Country name is too long";
				 ...
				 header('Location:'.$user->username);  //redirectionare catre profil
			}
		}else{
					...
					<form method="post" enctype="multipart/form-data">
						<ul>
							<li>
								...
								<input type="file" onchange="this.form.submit();" name="profileCover"onchange="this.form.submit();" id="file-up" />
							</li>
								<li>
								<label for="cover-upload-btn">
									Cancel
...
<div class="profile-nav">
	<div class="profile-navigation">
		...
		<div class="edit-button">
			<span>
            <button class="f-btn" type="button" onclick="window.location.href='<?php echo  $user->username; ?>'">Cancel</button>
			</span>
			<span>
...
<div class="in-center">
	<div class="in-center-wrap">
		<?php  $tweets=$getFromT->getUserTweets($user_id);  
		foreach ($tweets as $tweet) {
			...
			<div class="t-show-wrap">   
			 <div class="t-show-inner">
				' . (($retweet && $retweet['retweetID'] === $tweet->retweetID) || $tweet->retweetID > 0 ? '
			...
			' : '
				...
				<div class="t-show-footer">
					<div class="t-s-f-right">
						...
						<li><button><a href="#"><i class="fa fa-share" aria-hidden="true"></i></a></button></li>
			<li>'.(isset($retweet) && $retweet !== false && $tweet->tweetID === $retweet['retweetID'] ? 
			...
			<li>'.(isset($likes) && $likes !== false && $likes['likeOn'] === $tweet->tweetID ? 
