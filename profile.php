    ...
    <div class="header-wrapper">
        <div class="nav-container">
            <div class="nav">
                <div class="nav-left">
                    <ul>
                        <li><a href="<?php echo BASE_URL; ?>home.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>  <!--link-->
                ...
                <div class="nav-right">
                    <ul>
                        ...
                        <?php } else { ?>
                            <li><a href="<?php echo BASE_URL; ?>index.php">Have an account? Log in!</a></li>
                        <?php } ?>
                    </ul>
                </div><!-- nav right ends-->
            </div><!-- nav ends -->
            ...
            <div class="profile-navigation">
                <ul>
                    <li>
                        ...
                        <div class="n-bottom"><?php $getFromT->countTweets($profileId); ?></div>
                    </li>
                    <li>
                        <a href="<?php echo BASE_URL.$profileData->username; ?>/following">
                            <div class="n-head">FOLLOWING</div>
                    ...
                    <li>
                        <a href="<?php echo BASE_URL.$profileData->username; ?>/followers">
                            ...
                            <div class="n-bottom"><span class="count-followers"><?php echo $profileData->followers; ?></span></div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="n-head">LIKES</div>
                            <div class="n-bottom"><?php $getFromT->countLikes($profileId); ?></div>
                        </a>
                    </li>
                </ul>
                <div class="edit-button">
                    <span><?php echo $getFromF->followBtn($profileId, $user_id, $profileData->user_id); ?></span>
                </div>
            </div>
        </div>
                                    ...
                                    <ul>
                                        <?php if (!empty($profileData->country)) { ?>
                                            <li>
                                                ...
                                                <div class="profile-ex-location"><?php echo $profileData->country; ?></div>
                                            </li>
                                        <?php } ?>
                        ...
                        echo '<div class="all-tweet">
                            ...
                            (((isset($retweet['tweetID'])) ? !empty($tweet->retweetMsg) && $tweet->tweetID === $retweet['tweetID'] or $tweet->retweetID > 0 : '') ? '<div class="t-show-head">
                                    <div class="t-show-popup" data-tweet="' . $tweet->tweetID . '">
                                        ...
                                        <div class="t-s-head-content">
                                            ...
                                            <div class="t-h-c-dis">' . $getFromT->getTweetLinks($tweet->retweetMsg) . '</div>
                                        </div>
                                    </div>
                            ...
                            ((!empty($tweet->tweetImage)) ? '
                                                ...
                                                <div>
                                                    ...
                                                    <div class="retweet-t-s-b-inner-right-text">' . $getFromT->getTweetLinks($tweet->status) . '</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="t-show-popup" data-tweet="' . $tweet->tweetID . '">
                                        <div class="t-show-head">
                                            ...
                                            <div class="t-s-head-content">
                                                ...
                                                <div class="t-h-c-dis">' . $getFromT->getTweetLinks($tweet->status) . '</div>
                                            </div>
                                        </div>' .
                            ...
                            (($getFromU->loggedIn() === true) ? '
                                                ...
                                                ' . (($tweet->tweetBy === $user_id) ? '<li><a href="#" class="more"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a><ul><li><label class="deleteTweet" data-tweet="' . $tweet->tweetID . '">Delete Tweet</label></li></ul></li>' : '') . '
                                            ' : '<li><button><i class="fa fa-share" aria-hidden="true"></i></button></li><li><button><i class="fa fa-retweet" aria-hidden="true"></i></button></li><li><button><i class="fa fa-heart" aria-hidden="true"></i></button></li>') . '
                                            </ul>
                                        </div>
                                    </div>
                                </div>
